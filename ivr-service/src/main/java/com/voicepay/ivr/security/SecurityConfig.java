    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/h2-console/**", "/swagger-ui/**", "/v3/api-docs/**", "/ivr/v3/api-docs/**", "/ws/**", "/actuator/**").permitAll()
                .requestMatchers("/ivr/twilio-call", "/ivr/twilio-amd-callback", "/ivr/twilio-webhook", "/ivr/twilio-pay-action", "/ivr/twilio-status", "/ivr/outbound", "/ivr/payment-callback").permitAll()
