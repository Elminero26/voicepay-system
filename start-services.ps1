...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "`$env:JAVA_HOME='C:\Program Files\Java\jdk-21'; ./mvnw spring-boot:run -pl notification-service" -WindowStyle Normal
